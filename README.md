...
running command...
$ functest (--version)
functest/0.0.36 darwin-arm64 node-v22.3.0
...
_See code: [src/commands/java/springboot.ts](https://github.com/SlothManDan/REST-FuncTest/blob/v0.0.36/src/commands/java/springboot.ts)_
